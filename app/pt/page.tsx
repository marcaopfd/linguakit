  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)' }}>
      <div style={{ background: 'var(--ink)', color: 'var(--cream)', padding: '3rem 2rem 2.5rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: 32, fontWeight: 600, letterSpacing: '-.5px', marginBottom: '.3rem' }}>Portuguese Course</h1>
        <p style={{ fontSize: 14, color: 'rgba(255,255,255,.55)', lineHeight: 1.6, maxWidth: 340 }}>
          Português para falantes de inglês · A1 → C2 · {totalUnits} units
        </p>
